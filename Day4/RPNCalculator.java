...
public class RPNCalculator {
	...
	public static String[] getInput() {
		...
		System.out.print("Please type the RPN equation to be solved with spaces between " +
	...
	public static void solve(String[] equation) {
		...
		for (String str : equation) {
			/*Check for operators to trigger operation and push result to stack then continue loop
			 *Else parse the Float and push it to the stack, then continue loop */
			if (str.equals("+")) {
				operand2 = stack.pop();
		        operand1 = stack.pop();
